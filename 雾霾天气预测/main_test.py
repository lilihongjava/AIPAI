...
def main_test():
    ...
    #拆分
    split(split_ratio=0.8,random_seed_num=1,input="./data/normalized_out", output="./data/split_out", output1="./data/split_out1")
    #逻辑回归二分类
    ...
    # 二分类评估 ./data/prediction_out
    #two_category_assessment(original_label_column=2, input="./data/test_prediction_out2.csv", output="./data/tca_out",output1="./data/tca_out1", output2="./data/tca_out2")
    #随机森林
